...
final_instruction = """
    ...
    Always abstract individual discussions into the broader recurring user problem.

    Do not focus on isolated feature requests or implementation details.

    Identify the common workflow, unmet need, or repetitive task shared by most discussions.

    Assume some discussions are edge cases. Focus on the dominant pattern represented by the cluster rather than rare requests.
